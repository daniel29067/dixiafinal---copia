...
public class HUDunirverbro extends Stage {

    private Label mBonesLabel;

    private PbrochaScript mPlayerScript;
    ...
    public HUDunirverbro(Skin skin, TextureAtlas atlas, Viewport viewport, Batch batch) {
        ...
        upButton.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                mPlayerScript.movePlayer(PbrochaScript.JUMP);
            }
        });
    ...
    public void setPbrochaScript(PbrochaScript pbrochaScript) {
        mPlayerScript = pbrochaScript;
    }
    ...
    public void act(float delta) {
        ...
        if (leftClicked)
            mPlayerScript.movePlayer(PbrochaScript.LEFT);
        if (rightClicked)
            mPlayerScript.movePlayer(PbrochaScript.RIGHT);
