...
public class HUDunirbru extends Stage {

    private Label mBonesLabel;

    private Ipbruja1Script mPlayerScript;
    ...
    public HUDunirbru(Skin skin, TextureAtlas atlas, Viewport viewport, Batch batch) {
        ...
        upButton.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                mPlayerScript.movePlayer(Ipbruja1Script.JUMP);
            }
        });
    ...
    public void setIpbruja1Script(Ipbruja1Script ipbruja1Script) {
        mPlayerScript = ipbruja1Script;
    }
    ...
    public void act(float delta) {
        ...
        if (leftClicked)
            mPlayerScript.movePlayer(Ipbruja1Script.LEFT);
        if (rightClicked)
            mPlayerScript.movePlayer(Ipbruja1Script.RIGHT);
