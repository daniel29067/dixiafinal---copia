...
public class HUDunirverbre extends Stage {

    private Label mBonesLabel;

    private PbrevaScript mPlayerScript;
    ...
    public HUDunirverbre(Skin skin, TextureAtlas atlas, Viewport viewport, Batch batch) {
        ...
        upButton.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                mPlayerScript.movePlayer(PbrevaScript.JUMP);
            }
        });
    ...
    public void setPbrevaScript(PbrevaScript pbrevaScript) {
        mPlayerScript = pbrevaScript;
    }
    ...
    public void act(float delta) {
        ...
        if (leftClicked)
            mPlayerScript.movePlayer(PbrevaScript.LEFT);
        if (rightClicked)
            mPlayerScript.movePlayer(PbrevaScript.RIGHT);
