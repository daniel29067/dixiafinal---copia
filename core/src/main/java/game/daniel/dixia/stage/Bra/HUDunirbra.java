...
public class HUDunirbra extends Stage {

    private Label mBonesLabel;

    private Ipbrazo1Script mPlayerScript;
    ...
    public HUDunirbra(Skin skin, TextureAtlas atlas, Viewport viewport, Batch batch) {
        ...
        upButton.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                mPlayerScript.movePlayer(Ipbrazo1Script.JUMP);
            }
        });
    ...
    public void setIpbrazo1Script(Ipbrazo1Script ipbrazo1Script) {
        mPlayerScript = ipbrazo1Script;
    }
    ...
    public void act(float delta) {
        ...
        if (leftClicked)
            mPlayerScript.movePlayer(Ipbrazo1Script.LEFT);
        if (rightClicked)
            mPlayerScript.movePlayer(Ipbrazo1Script.RIGHT);
