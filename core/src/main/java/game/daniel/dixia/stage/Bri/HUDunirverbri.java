...
public class HUDunirverbri extends Stage {

    private Label mBonesLabel;

    private PbrincoScript mPlayerScript;
    ...
    public HUDunirverbri(Skin skin, TextureAtlas atlas, Viewport viewport, Batch batch) {
        ...
        upButton.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                mPlayerScript.movePlayer(PbrincoScript.JUMP);
            }
        });
    ...
    public void setPbrincoScript(PbrincoScript pbrincoScript) {
        mPlayerScript = pbrincoScript;
    }
    ...
    public void act(float delta) {
        ...
        if (leftClicked)
            mPlayerScript.movePlayer(PbrincoScript.LEFT);
        if (rightClicked)
            mPlayerScript.movePlayer(PbrincoScript.RIGHT);
