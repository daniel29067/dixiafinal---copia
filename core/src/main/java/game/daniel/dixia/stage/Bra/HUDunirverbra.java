...
public class HUDunirverbra extends Stage {

    private Label mBonesLabel;

    private PbrazoScript mPlayerScript;
    ...
    public HUDunirverbra(Skin skin, TextureAtlas atlas, Viewport viewport, Batch batch) {
        ...
        upButton.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                mPlayerScript.movePlayer(PbrazoScript.JUMP);
            }
        });
    ...
    public void setPbrazoScript(PbrazoScript pbrazoScript) {
        mPlayerScript = pbrazoScript;
    }
    ...
    public void act(float delta) {
        ...
        if (leftClicked)
            mPlayerScript.movePlayer(PbrazoScript.LEFT);
        if (rightClicked)
            mPlayerScript.movePlayer(PbrazoScript.RIGHT);
