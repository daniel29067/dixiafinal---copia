package game.daniel.dixia.stage.Bri;
...
public class HUDlaberintobri extends Stage {


    private Label mBonesLabel;

    private IbrincoScript mPlayerScript;
    ...
    public HUDlaberintobri(Skin skin, TextureAtlas atlas, Viewport viewport, Batch batch) {
        ...
        upButton.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                mPlayerScript.movePlayer(IbrincoScript.JUMP);
            }
        });
    ...
    public void setPlayerScript(IbrincoScript ibrincoScript) {
        mPlayerScript = ibrincoScript;
    }
    ...
    public void act(float delta) {
        ...
        if (leftClicked)
            mPlayerScript.movePlayer(IbrincoScript.LEFT);
        if (rightClicked)
            mPlayerScript.movePlayer(IbrincoScript.RIGHT);
