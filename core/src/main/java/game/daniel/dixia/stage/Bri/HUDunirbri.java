...
public class HUDunirbri extends Stage {

    private Label mBonesLabel;

    private Ipbrinco1Script mPlayerScript;
    ...
    public HUDunirbri(Skin skin, TextureAtlas atlas, Viewport viewport, Batch batch) {
        ...
        upButton.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                mPlayerScript.movePlayer(Ipbrinco1Script.JUMP);
            }
        });
    ...
    public void setIpbrinco1Script(Ipbrinco1Script ipbrinco1Script) {
        mPlayerScript = ipbrinco1Script;
    }
    ...
    public void act(float delta) {
        ...
        if (leftClicked)
            mPlayerScript.movePlayer(Ipbrinco1Script.LEFT);
        if (rightClicked)
            mPlayerScript.movePlayer(Ipbrinco1Script.RIGHT);
