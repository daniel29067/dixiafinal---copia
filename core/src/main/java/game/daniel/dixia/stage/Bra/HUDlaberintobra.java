package game.daniel.dixia.stage.Bra;
...
public class HUDlaberintobra extends Stage {


    private Label mBonesLabel;

    private IbrazoScript mPlayerScript;
    ...
    public HUDlaberintobra(Skin skin, TextureAtlas atlas, Viewport viewport, Batch batch) {
        ...
        upButton.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                mPlayerScript.movePlayer(IbrazoScript.JUMP);
            }
        });
    ...
    public void setPlayerScript(IbrazoScript ibrazoScript) {
        mPlayerScript = ibrazoScript;
    }
    ...
    public void act(float delta) {
        ...
        if (leftClicked)
            mPlayerScript.movePlayer(IbrazoScript.LEFT);
        if (rightClicked)
            mPlayerScript.movePlayer(IbrazoScript.RIGHT);
