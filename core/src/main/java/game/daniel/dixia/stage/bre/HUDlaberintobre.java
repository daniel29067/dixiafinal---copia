package game.daniel.dixia.stage.bre;
...
public class HUDlaberintobre extends Stage {


    private Label mBonesLabel;

    private IbrevaScript mPlayerScript;
    ...
    public HUDlaberintobre(Skin skin, TextureAtlas atlas, Viewport viewport, Batch batch) {
        ...
        upButton.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                mPlayerScript.movePlayer(IbrevaScript.JUMP);
            }
        });
    ...
    public void setPlayerScript(IbrevaScript ibrevaScript) {
        mPlayerScript = ibrevaScript;
    }
    ...
    public void act(float delta) {
        ...
        if (leftClicked)
            mPlayerScript.movePlayer(IbrevaScript.LEFT);
        if (rightClicked)
            mPlayerScript.movePlayer(IbrevaScript.RIGHT);
