...
public class HUDunirbre extends Stage {

    private Label mBonesLabel;

    private Ipbreva1Script mPlayerScript;
    ...
    public HUDunirbre(Skin skin, TextureAtlas atlas, Viewport viewport, Batch batch) {
        ...
        upButton.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                mPlayerScript.movePlayer(Ipbreva1Script.JUMP);
            }
        });
    ...
    public void setIpbrevaScript(Ipbreva1Script ipbreva1Script) {
        mPlayerScript = ipbreva1Script;
    }
    ...
    public void act(float delta) {
        ...
        if (leftClicked)
            mPlayerScript.movePlayer(Ipbreva1Script.LEFT);
        if (rightClicked)
            mPlayerScript.movePlayer(Ipbreva1Script.RIGHT);
