...
public class HUDlaberintobro extends Stage {


    private Label mBonesLabel;

    private IbrochaScript mPlayerScript;
    ...
    public HUDlaberintobro(Skin skin, TextureAtlas atlas, Viewport viewport, Batch batch) {
        ...
        upButton.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                mPlayerScript.movePlayer(IbrochaScript.JUMP);
            }
        });
    ...
    public void setPlayerScript(IbrochaScript ibrochaScript) {
        mPlayerScript = ibrochaScript;
    }
    ...
    public void act(float delta) {
        ...
        if (leftClicked)
            mPlayerScript.movePlayer(IbrochaScript.LEFT);
        if (rightClicked)
            mPlayerScript.movePlayer(IbrochaScript.RIGHT);
