package game.daniel.dixia.script.bre;
...
public class PbrevaScript extends BasicScript implements PhysicsContact {
    ...
    public PbrevaScript(PooledEngine engine) {
        mEngine = engine;
    }
    ...
    public void init(Entity item) {
        ...
        animEntity = itemWrapper.getChild("breva2").getEntity();
    ...
    public Pbreva1Component getPlayerComponent() {
        return ComponentRetriever.get(animEntity, Pbreva1Component.class);
    }
    ...
    public void beginContact(Entity contactEntity, Fixture contactFixture, Fixture ownFixture, Contact contact) {
        ...
        Pbreva1Component playerComponent = ComponentRetriever.get(animEntity, Pbreva1Component.class);

        if (mainItemComponent.tags.contains("palabrabre1")){
            playerComponent.touchedWords++;}
        if (mainItemComponent.tags.contains("palabrabre2")){
            playerComponent.touchedWords++;}
        if (mainItemComponent.tags.contains("palabrabre3")){
            playerComponent.touchedWords++;}
        if (mainItemComponent.tags.contains("palabrabre4")){
            playerComponent.touchedWords++;}
        if (mainItemComponent.tags.contains("palabrabre5")){
            playerComponent.touchedWords++;}
