...
public class PbrazoScript extends BasicScript implements PhysicsContact {
    ...
    public PbrazoScript(PooledEngine engine) {
        mEngine = engine;
    }
    ...
    public void init(Entity item) {
        ...
        animEntity = itemWrapper.getChild("brazo2").getEntity();
    ...
    public Pbrazo1Component getPlayerComponent() {
        return ComponentRetriever.get(animEntity, Pbrazo1Component.class);
    }
    ...
    public void beginContact(Entity contactEntity, Fixture contactFixture, Fixture ownFixture, Contact contact) {
        ...
        Pbrazo1Component playerComponent = ComponentRetriever.get(animEntity, Pbrazo1Component.class);

        if (mainItemComponent.tags.contains("palabrabra1")){
            playerComponent.touchedWords++;}
        if (mainItemComponent.tags.contains("palabrabra2")){
            playerComponent.touchedWords++;}
        if (mainItemComponent.tags.contains("palabrabra3")){
            playerComponent.touchedWords++;}
        if (mainItemComponent.tags.contains("palabrabra4")){
            playerComponent.touchedWords++;}
        if (mainItemComponent.tags.contains("palabrabra5")){
            playerComponent.touchedWords++;}
