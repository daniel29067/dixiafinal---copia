...
public class Ipbreva1Script extends BasicScript implements PhysicsContact {
    ...
    public Ipbreva1Script(PooledEngine engine) {
        mEngine = engine;
    }
    ...
    public void init(Entity item) {
        ...
        animEntity = itemWrapper.getChild("breva").getEntity();
    ...
    public Ipbreva1Component getPlayerComponent() {
        return ComponentRetriever.get(animEntity, Ipbreva1Component.class);
    }
    ...
    public void beginContact(Entity contactEntity, Fixture contactFixture, Fixture ownFixture, Contact contact) {
        ...
        Ipbreva1Component playerComponent = ComponentRetriever.get(animEntity, Ipbreva1Component.class);
