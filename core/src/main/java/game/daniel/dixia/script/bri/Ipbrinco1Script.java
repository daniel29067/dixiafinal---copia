...
public class Ipbrinco1Script extends BasicScript implements PhysicsContact {
    ...
    public Ipbrinco1Script(PooledEngine engine) {
        mEngine = engine;
    }
    ...
    public void init(Entity item) {
        ...
        animEntity = itemWrapper.getChild("ipbrinco").getEntity();
    ...
    public Ipbrinco1Component getPlayerComponent() {
        return ComponentRetriever.get(animEntity, Ipbrinco1Component.class);
    }
    ...
    public void beginContact(Entity contactEntity, Fixture contactFixture, Fixture ownFixture, Contact contact) {
        ...
        Ipbrinco1Component playerComponent = ComponentRetriever.get(animEntity, Ipbrinco1Component.class);
