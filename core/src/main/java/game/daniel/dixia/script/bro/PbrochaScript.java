package game.daniel.dixia.script.bro;
...
public class PbrochaScript extends BasicScript implements PhysicsContact {
    ...
    public PbrochaScript(PooledEngine engine) {
        mEngine = engine;
    }
    ...
    public void init(Entity item) {
        ...
        animEntity = itemWrapper.getChild("brocha2").getEntity();
    ...
    public Pbrocha1Component getPlayerComponent() {
        return ComponentRetriever.get(animEntity, Pbrocha1Component.class);
    }
    ...
    public void beginContact(Entity contactEntity, Fixture contactFixture, Fixture ownFixture, Contact contact) {
        ...
        Pbrocha1Component playerComponent = ComponentRetriever.get(animEntity, Pbrocha1Component.class);

        if (mainItemComponent.tags.contains("palabrabro1")){
            playerComponent.touchedWords++;}
        if (mainItemComponent.tags.contains("palabrabro2")){
            playerComponent.touchedWords++;}
        if (mainItemComponent.tags.contains("palabrabro3")){
            playerComponent.touchedWords++;}
        if (mainItemComponent.tags.contains("palabrabro4")){
            playerComponent.touchedWords++;}
        if (mainItemComponent.tags.contains("palabrabro5")){
            playerComponent.touchedWords++;}
