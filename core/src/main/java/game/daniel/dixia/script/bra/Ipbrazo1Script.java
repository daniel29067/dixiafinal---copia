...
public class Ipbrazo1Script extends BasicScript implements PhysicsContact {
    ...
    public Ipbrazo1Script(PooledEngine engine) {
        mEngine = engine;
    }
    ...
    public void init(Entity item) {
        ...
        animEntity = itemWrapper.getChild("brazo").getEntity();
    ...
    public Ipbrazo1Component getPlayerComponent() {
        return ComponentRetriever.get(animEntity, Ipbrazo1Component.class);
    }
    ...
    public void beginContact(Entity contactEntity, Fixture contactFixture, Fixture ownFixture, Contact contact) {
        ...
        Ipbrazo1Component playerComponent = ComponentRetriever.get(animEntity, Ipbrazo1Component.class);
