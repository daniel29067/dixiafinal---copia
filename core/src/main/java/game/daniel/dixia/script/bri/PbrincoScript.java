package game.daniel.dixia.script.bri;
...
public class PbrincoScript extends BasicScript implements PhysicsContact {
    ...
    public PbrincoScript(PooledEngine engine) {
        mEngine = engine;
    }
    ...
    public void init(Entity item) {
        ...
        animEntity = itemWrapper.getChild("brinco2").getEntity();
    ...
    public Pbrinco1Component getPlayerComponent() {
        return ComponentRetriever.get(animEntity, Pbrinco1Component.class);
    }
    ...
    public void beginContact(Entity contactEntity, Fixture contactFixture, Fixture ownFixture, Contact contact) {
        ...
        Pbrinco1Component playerComponent = ComponentRetriever.get(animEntity, Pbrinco1Component.class);

        if (mainItemComponent.tags.contains("palabrabri1")){
            playerComponent.touchedWords++;}
        if (mainItemComponent.tags.contains("palabrabri2")){
            playerComponent.touchedWords++;}
        if (mainItemComponent.tags.contains("palabrabri3")){
            playerComponent.touchedWords++;}
        if (mainItemComponent.tags.contains("palabrabri4")){
            playerComponent.touchedWords++;}
        if (mainItemComponent.tags.contains("palabrabri5")){
            playerComponent.touchedWords++;}
