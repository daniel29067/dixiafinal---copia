...
public class Ipbruja1Script extends BasicScript implements PhysicsContact {
    ...
    public Ipbruja1Script(PooledEngine engine) {
        mEngine = engine;
    }
    ...
    public void init(Entity item) {
        ...
        animEntity = itemWrapper.getChild("ipbruja").getEntity();
    ...
    public Ipbruja1Component getPlayerComponent() {
        return ComponentRetriever.get(animEntity, Ipbruja1Component.class);
    }
    ...
    public void beginContact(Entity contactEntity, Fixture contactFixture, Fixture ownFixture, Contact contact) {
        ...
        Ipbruja1Component playerComponent = ComponentRetriever.get(animEntity, Ipbruja1Component.class);
