...
public class Ipbrocha1Script  extends BasicScript implements PhysicsContact {
    ...
    public Ipbrocha1Script(PooledEngine engine) {
        mEngine = engine;
    }
    ...
    public void init(Entity item) {
        ...
        animEntity = itemWrapper.getChild("ipbrocha").getEntity();
    ...
    public Ipbrocha1Component getPlayerComponent() {
        return ComponentRetriever.get(animEntity, Ipbrocha1Component.class);
    }
    ...
    public void beginContact(Entity contactEntity, Fixture contactFixture, Fixture ownFixture, Contact contact) {
        ...
        Ipbrocha1Component playerComponent = ComponentRetriever.get(animEntity, Ipbrocha1Component.class);
